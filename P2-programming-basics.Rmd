...
- Type `hist(x=rnorm(300))` and see what happens. What do you think the `hist()` function does?
...
- Why doesn't this return `TRUE` (Hint: [read ahead](L3.1-functions.html#7_tips) to find out): `(0.1 + 0.2) == 0.3`
