...
--
### Quiz 3 next week, Midterm 1 week after that
...
Write a function that takes a vector of numbers `a` and returns the median value in the vector, which is the value of the middle element (or the average of the two middle elements). Test cases:
