...
--
2) Download the `week10notes.zip` file for class today (link in `slack/classroom`).
...
First, read in the `wildlife_impacts.csv` file that is in the `data` folder.

Call the data frame `df`.
<br>
<br>

Then, use the `df` object to answer the following questions:
