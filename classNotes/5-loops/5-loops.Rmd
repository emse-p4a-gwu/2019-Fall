...
2) `sumOfOddsFromMToN(m, n)`: Write a function that sums every _odd_ integer between `m` and `n`. **Bonus**: Try solving this without a loop (Hint: use a vector operation...we'll cover this next week!).
