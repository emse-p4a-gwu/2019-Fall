...
1) Before beginning this assignment, be sure to have read the [Getting Started](L1.2-getting-started.html), [Programming Basics](L1.3-programming-basics.html), and [Functions](L3.1-functions.html) lessons.

2) Open RStudio and create a new project called "hw2-lastName", replacing "lastName" with your last name.

3) Download the [hw2.R template script](https://github.com/emse6574-gwu/2019-Fall/raw/gh-pages/hw/hw2-template.R){target="_blank"} and place it in RStudio project folder you just created.
