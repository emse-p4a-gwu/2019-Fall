...
2) Download the [hw2.R template script](https://github.com/emse6574-gwu/2019-Fall/raw/gh-pages/hw/hw2-template.R){target="_blank"} and place it in RStudio project folder you just created.

3) Fill out your name, GW Net ID, and the names of anyone you worked with in the header of the "hw2.R" file.

4) Type all of your answers to the questions below in the "hw2.R" script.
...
**Write solutions to the following functions in your "hw2.R" script.** Rules:

- For functions 1-7, you may **NOT** use loops or conditionals
- For functions 8-9, you may use conditionals, but you may **NOT** use loops.

### 1) `integerSquareRoot(x)`
