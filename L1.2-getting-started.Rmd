...
```{r}
123456 %% 1 # "Chops" on the right of the ones digit
123456 %% 10 # "Chops" on the right of the tens digit
123456 %% 100 # "Chops" on the right of the hundreds digit
```

You can get the opposite by using integer division operator (`%/%`) - in this case, everything to the _left_ of the "chop" point is returned. For example:
...
- The "chop" point is always just to the _right_ of the chopping digit:
    - `123456 %% 1` -> chop to the _right_ of the `1`'s place: `123456 <chop>`
    - `123456 %% 10` -> chop to the _right_ of the `10`'s place: `12345 <chop> 6`
    - `123456 %% 100` -> chop to the _right_ of the `100`'s place: `1234 <chop> 56`
- `%%` returns everything on the _right_ (`<chop> ->`)
- `%/%` returns everything on the _left_ (`<- <chop>`)
