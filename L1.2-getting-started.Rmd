...
The **modulus** (aka "mod" operator) returns the remainder after doing regular division. For example:

```{r}
17 %% 3
```

returns `2` because because 17 / 3 is equal to 5 with a remainder of 2. It works with decimals numbers too:
