...
You will often need to create new variables based on a condition. For example, perhaps you want to identify which of the observations in the wildlife impacts data cost more than $10,000 in damages. Well
...
spicegirls %>%
    mutate(
        nameIsMel = ifelse(firstName == 'Melanie', TRUE, FALSE))
```
