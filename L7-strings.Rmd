...
If you want to count the unique occurence of component letters in a string, you can use the `table()` function on the vector of letters that come from splitting the string:

```{r}
letters <- str_split(s, "")[[1]]
letterCounts <- table(letters)
sort(letterCounts, decreasing = TRUE)
```
