You will inevitably run into problems while learning R. The best starting point for troubleshooting is Google and [Stackoverflow](https://stackoverflow.com/). In addition, these resources can also be helpful:
