...
Instructor | Course
---|---
<i class="fas fa-user"></i> John Paul Helveston | <i class="far fa-calendar"> Mondays
...
<!-- Also took this idea (so brilliant) from https://evalf19.classes.andrewheiss.com/syllabus/#cute-animals -->

# Cute Animals

![](images/cute_hedgehog.gif)
