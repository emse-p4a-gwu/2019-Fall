...
a) Create variables for the price and fuel economy of each vehicle as well as for the total miles Max drives each year and the price of gasoline. Use variable names that make sense and are easy to understand.
