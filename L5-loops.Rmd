...
> ### Suggested Readings
>
> * [Chapter 21](https://r4ds.had.co.nz/iteration.html){target="_blank"} of "R for Data Science", by Garrett Grolemund and Hadley Wickham
> * [Chapters 11](https://rstudio-education.github.io/hopr/loops.html){target="_blank"} of "Hands-On Programming with R", by Garrett Grolemund
...
This will come in handy when working with 2-dimensional objects like [matrices](L10-matrices.html) and [data frames](L11-data-frames.html).

---

# The `while` loop

> A man calls his programmer spouse and says, "while you're out, buy some milk"...she never returned home.
>
