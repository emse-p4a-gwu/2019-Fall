...
[Note: Some content in this page is sourced from other courses - citations are in the footnotes]^[Soome content in this page is sourced from: 1) Danielle Navarro's website ["R for Psychological Science"](https://psyr.org/index.html); 2) Jenny Bryan's [STAT 545 Course](http://stat545.com/); 3) [RStudio primers](https://rstudio.cloud/learn/primers/1.2); 4) Xiao Ping Song's [Intro2R crash course](https://github.com/xp-song/Intro2R)]
...
install.packages(packagename)   # This won't work
```
